...
<div class="container">
  ...
  <form action="/pessoa/cadastrar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input class="form-control" name="numero" placeholder="Infome seu numero" required type="text">
    </div>
    <div class="form-group">
      <label>Complemento</label>
      <input class="form-control" name="complemento" placeholder="Infome um complemento" type="text">
    </div>
